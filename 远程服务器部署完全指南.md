...
$action = New-ScheduledTaskAction -Execute "D:\aerovla-server\aerovla\Scripts\python.exe" `
    -Argument "aerovla_server.py" `
    -WorkingDirectory "D:\aerovla-server"
...
Register-ScheduledTask -TaskName "AeroVLA" -Action $action -Trigger $trigger -Settings $settings -Force -RunLevel Highest

# 在系统环境变量中设置（管理员 PowerShell）：
[Environment]::SetEnvironmentVariable("AEROVLA_BASE_MODEL", "D:\aerovla-server\openvla-7b", "Machine")
[Environment]::SetEnvironmentVariable("AEROVLA_LORA", "D:\aerovla-server\openvla-7b\weight-lora\aerial_vla", "Machine")
[Environment]::SetEnvironmentVariable("AEROVLA_PORT", "6006", "Machine")
[Environment]::SetEnvironmentVariable("AEROVLA_HOST", "0.0.0.0", "Machine")
